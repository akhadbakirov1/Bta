            ...
            <div className="newsinner-main">
                <div className="newsinner-bg-blue">
                    <div className="newsinner-bg-white">
                        ...
                        <img className='newsinner-img' src={NewsImg2} alt="" />
...
მოტივაციური გასაუბრების და პროფესიული ტესტირების საბოლოო შედეგები გამოცხადდება
 ...
 პროფესიული საგანმანათლებლო პროგრამისა და პროფესიული საგანმანათლებლო დაწესებულების საბოლოო არჩევანის მონიშვნა შესაძლებელი იქნება 17 და 18 ოქტომბერს.</p>
                    </div>
                </div>
            </div>
            <UsefulLinks/>
